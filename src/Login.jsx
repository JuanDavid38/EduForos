function Login() {
    return (
        ...
        <div class="container bg-black border: black 2px solid">
            
            <section class="h-screen">
                <div class="container h-full px-6 py-24 border: black 3px solid">
                    <div class="g-4 flex h-full flex-wrap items-center justify-center lg:justify-between">
                        
                        <div class="mb-12 md:mb-0 md:w-8/12 lg:w-6/12">
                            <img src="../img/tecnologia-5.jpg" class="w-full" alt="Phone image" />
                        </div>
